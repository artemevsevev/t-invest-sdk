...
impl InstrumentType {
    ...
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
        match value {
            ...
            "INSTRUMENT_TYPE_DFA" => Some(Self::Dfa),
            _ => None,
        }
    }
}
...
impl SecurityTradingStatus {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            ...
            Self::StabilizationAuction => "SECURITY_TRADING_STATUS_STABILIZATION_AUCTION",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
        match value {
            ...
            "SECURITY_TRADING_STATUS_STABILIZATION_AUCTION" => {
                Some(Self::StabilizationAuction)
            }
            _ => None,
        }
    }
...
#[derive(Clone, Copy, PartialEq, Eq, Hash, ::prost::Message)]
pub struct DfasRequest {}
/// Цифровой актив
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct DfaResponse {
    /// Уникальный идентификатор инструмента.
    #[prost(string, tag = "1")]
    pub uid: ::prost::alloc::string::String,
    /// Тикер инструмента.
    ...
    pub basic_assets: ::prost::alloc::vec::Vec<dfa_response::BasicAsset>,
    /// Прогнозная доходность смарт-портфелей, в виде интервала в %.
    #[prost(message, optional, tag = "21")]
    pub forecast_yield: ::core::option::Option<dfa_response::ForecastYield>,
    /// Доходность к погашению в %.
    #[prost(message, optional, tag = "22")]
    pub yield_to_maturity: ::core::option::Option<Quotation>,
    /// Величина купона.
    #[prost(message, optional, tag = "23")]
    pub coupon_value: ::core::option::Option<Quotation>,
    /// Количество выплат в год.
    #[prost(int32, tag = "24")]
    pub coupon_payment_frequency: i32,
    /// Дата выплаты купона.
    #[prost(message, optional, tag = "25")]
    pub coupon_payment_date: ::core::option::Option<::prost_types::Timestamp>,
    /// Значение НКД (накопленного купонного дохода) на дату.
    #[prost(message, optional, tag = "26")]
    pub aci_value: ::core::option::Option<Quotation>,
}
/// Nested message and enum types in `DfaResponse`.
pub mod dfa_response {
    /// Базовый актив.
    #[derive(Clone, PartialEq, Eq, Hash, ::prost::Message)]
    pub struct BasicAsset {
        /// UID базового актива
    ...
    #[derive(Clone, Copy, PartialEq, Eq, Hash, ::prost::Message)]
    pub struct ForecastYield {
        /// Минимальное значение прогнозной доходности в %
        #[prost(message, optional, tag = "1")]
        pub min_value: ::core::option::Option<super::Quotation>,
        /// Максимальное значение прогнозной доходности в %
        #[prost(message, optional, tag = "2")]
        pub max_value: ::core::option::Option<super::Quotation>,
    }
}
/// Цифровые активы
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct DfasResponse {
    /// Массив инструментов.
    #[prost(message, repeated, tag = "1")]
    pub instruments: ::prost::alloc::vec::Vec<DfaResponse>,
}
/// Тип купонов.
#[derive(Clone, Copy, Debug, PartialEq, Eq, Hash, PartialOrd, Ord, ::prost::Enumeration)]
#[repr(i32)]
...
impl InstrumentIdType {
    ...
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
        match value {
            ...
            "INSTRUMENT_ID_TYPE_ID" => Some(Self::Id),
            _ => None,
        }
    }
}
...
pub mod instruments_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn dfa_by(
            &mut self,
            request: impl tonic::IntoRequest<super::InstrumentRequest>,
        ) -> std::result::Result<tonic::Response<super::DfaResponse>, tonic::Status> {
            self.inner
                .ready()
                .await
                .map_err(|e| {
        ...
        pub async fn dfas(
            &mut self,
            request: impl tonic::IntoRequest<super::DfasRequest>,
        ) -> std::result::Result<tonic::Response<super::DfasResponse>, tonic::Status> {
            self.inner
                .ready()
                .await
                .map_err(|e| {
...
pub struct Operation {
    ...
    pub child_operations: ::prost::alloc::vec::Vec<ChildOperationItem>,
}
/// Сделка по операции.
#[derive(Clone, PartialEq, Eq, Hash, ::prost::Message)]
...
pub struct PortfolioResponse {
    ...
    #[prost(message, optional, tag = "16")]
    pub daily_yield_relative: ::core::option::Option<Quotation>,
    /// Общая стоимость смарт-активов в портфеле в рублях.
    #[prost(message, optional, tag = "17")]
    pub total_amount_dfa: ::core::option::Option<MoneyValue>,
}
...
pub struct PositionsStreamRequest {
    ...
    #[prost(bool, tag = "3")]
    pub with_initial_positions: bool,
    /// Запрос настройки пинга.
    #[prost(message, optional, tag = "15")]
    pub ping_settings: ::core::option::Option<PingDelaySettings>,
}
...
pub struct PositionsStreamResponse {
    #[prost(oneof = "positions_stream_response::Payload", tags = "1, 2, 3, 5")]
...
pub mod positions_stream_response {
    ...
    pub enum Payload {
        ...
        /// Текущие позиции.
        #[prost(message, tag = "5")]
        InitialPositions(super::PositionsResponse),
    }
}
/// Объект результата подписки.
#[derive(Clone, PartialEq, ::prost::Message)]
...
pub struct TradesStreamResponse {
    #[prost(oneof = "trades_stream_response::Payload", tags = "1, 2, 3")]
...
pub struct PostOrderAsyncRequest {
    ...
    pub order_id: ::prost::alloc::string::String,
    /// Алгоритм исполнения поручения, применяется только к лимитной заявке.
    #[prost(enumeration = "TimeInForceType", optional, tag = "8")]
    pub time_in_force: ::core::option::Option<i32>,
    /// Тип цены.
    #[prost(enumeration = "PriceType", optional, tag = "9")]
...
#[derive(Clone, PartialEq, Eq, Hash, ::prost::Message)]
pub struct PostOrderAsyncResponse {
    /// Идентификатор ключа идемпотентности, переданный клиентом, в формате UID. Максимальная длина 36 символов.
    #[prost(string, tag = "1")]
    pub order_request_id: ::prost::alloc::string::String,
    /// Текущий статус заявки.
    ...
    /// Идентификатор торгового поручения.
    #[prost(string, optional, tag = "3")]
    pub trade_intent_id: ::core::option::Option<::prost::alloc::string::String>,
}
...
pub struct CancelOrderRequest {
    ...
    #[prost(enumeration = "OrderIdType", optional, tag = "3")]
    pub order_id_type: ::core::option::Option<i32>,
}
...
pub struct GetOrderStateRequest {
    ...
    pub price_type: i32,
    /// Тип идентификатора заявки.
    #[prost(enumeration = "OrderIdType", optional, tag = "4")]
    pub order_id_type: ::core::option::Option<i32>,
}
...
pub struct GetOrdersRequest {
    ...
    #[prost(message, optional, tag = "2")]
    pub advanced_filters: ::core::option::Option<
        get_orders_request::GetOrdersRequestFilters,
    >,
}
/// Nested message and enum types in `GetOrdersRequest`.
pub mod get_orders_request {
    #[derive(Clone, PartialEq, Eq, Hash, ::prost::Message)]
    pub struct GetOrdersRequestFilters {
        ...
        pub to: ::core::option::Option<::prost_types::Timestamp>,
        /// Статусы заявок.
        #[prost(enumeration = "super::OrderExecutionReportStatus", repeated, tag = "3")]
        pub execution_status: ::prost::alloc::vec::Vec<i32>,
    }
}
...
pub struct ReplaceOrderRequest {
    ...
    pub account_id: ::prost::alloc::string::String,
    /// Тип идентификатора заявки.
    #[prost(enumeration = "OrderIdType", optional, tag = "5")]
    pub order_id_type: ::core::option::Option<i32>,
...
pub struct SubscriptionResponse {
    ...
    pub tracking_id: ::prost::alloc::string::String,
    /// Статус подписки.
    #[prost(enumeration = "ResultSubscriptionStatus", tag = "2")]
    pub status: i32,
    /// Идентификатор открытого соединения
    #[prost(string, tag = "4")]
    pub stream_id: ::prost::alloc::string::String,
...
pub mod order_state_stream_response {
    ...
    impl MarkerType {
        ...
        pub fn as_str_name(&self) -> &'static str {
            match self {
                ...
                Self::MarkerBroker => "MARKER_BROKER",
                Self::MarkerChat => "MARKER_CHAT",
                Self::MarkerPaper => "MARKER_PAPER",
                Self::MarkerMargin => "MARKER_MARGIN",
                Self::MarkerTkbnm => "MARKER_TKBNM",
                Self::MarkerShort => "MARKER_SHORT",
                Self::MarkerSpecmm => "MARKER_SPECMM",
                Self::MarkerPo => "MARKER_PO",
            }
        }
        /// Creates an enum from field names used in the ProtoBuf definition.
        pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
    ...
    impl StatusCauseInfo {
        ...
        pub fn as_str_name(&self) -> &'static str {
            match self {
                Self::CauseUnspecified => "CAUSE_UNSPECIFIED",
                Self::CauseCancelledByClient => "CAUSE_CANCELLED_BY_CLIENT",
                Self::CauseCancelledByExchange => "CAUSE_CANCELLED_BY_EXCHANGE",
                Self::CauseCancelledNotEnoughPosition => {
                    "CAUSE_CANCELLED_NOT_ENOUGH_POSITION"
                }
                Self::CauseCancelledByClientBlock => "CAUSE_CANCELLED_BY_CLIENT_BLOCK",
                Self::CauseRejectedByBroker => "CAUSE_REJECTED_BY_BROKER",
                Self::CauseRejectedByExchange => "CAUSE_REJECTED_BY_EXCHANGE",
                Self::CauseCancelledByBroker => "CAUSE_CANCELLED_BY_BROKER",
            }
        }
        /// Creates an enum from field names used in the ProtoBuf definition.
        pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
            match value {
                ...
                "CAUSE_CANCELLED_BY_CLIENT_BLOCK" => {
                    Some(Self::CauseCancelledByClientBlock)
                }
...
impl TimeInForceType {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            Self::TimeInForceUnspecified => "TIME_IN_FORCE_UNSPECIFIED",
            Self::TimeInForceDay => "TIME_IN_FORCE_DAY",
            Self::TimeInForceFillAndKill => "TIME_IN_FORCE_FILL_AND_KILL",
            Self::TimeInForceFillOrKill => "TIME_IN_FORCE_FILL_OR_KILL",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
impl OrderIdType {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            Self::Unspecified => "ORDER_ID_TYPE_UNSPECIFIED",
            Self::Exchange => "ORDER_ID_TYPE_EXCHANGE",
            Self::Request => "ORDER_ID_TYPE_REQUEST",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
        match value {
            "ORDER_ID_TYPE_UNSPECIFIED" => Some(Self::Unspecified),
            "ORDER_ID_TYPE_EXCHANGE" => Some(Self::Exchange),
            "ORDER_ID_TYPE_REQUEST" => Some(Self::Request),
            _ => None,
        }
    }
}
...
pub struct GetMarginAttributesResponse {
    ...
    #[prost(message, optional, tag = "7")]
    pub guarantee_for_futures: ::core::option::Option<MoneyValue>,
}
...
#[derive(Clone, PartialEq, Eq, Hash, ::prost::Message)]
pub struct GetAccountValuesRequest {
    /// Массив счетов пользователя.
    #[prost(string, repeated, tag = "1")]
    pub accounts: ::prost::alloc::vec::Vec<::prost::alloc::string::String>,
    /// Массив запрашиваемых параметров.
    #[prost(enumeration = "AccountValue", repeated, tag = "2")]
    pub values: ::prost::alloc::vec::Vec<i32>,
}
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct GetAccountValuesResponse {
    /// Массив счетов с параметрами.
    #[prost(message, repeated, tag = "1")]
    pub accounts: ::prost::alloc::vec::Vec<AccountValuesWithParameters>,
}
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct AccountValuesWithParameters {
    /// Номер счета.
    #[prost(string, tag = "1")]
    pub account_id: ::prost::alloc::string::String,
    /// Массив параметров инструмента.
    #[prost(message, repeated, tag = "2")]
    pub values: ::prost::alloc::vec::Vec<InstrumentParameter>,
}
#[derive(Clone, PartialEq, Eq, Hash, ::prost::Message)]
pub struct InstrumentParameter {
    /// Тип запрашиваемого параметра.
    #[prost(enumeration = "AccountValue", tag = "1")]
    pub name: i32,
    /// Значение запрашиваемого параметра.
    #[prost(message, optional, tag = "2")]
    pub value: ::core::option::Option<MoneyValue>,
}
/// Тип счeта.
#[derive(Clone, Copy, Debug, PartialEq, Eq, Hash, PartialOrd, Ord, ::prost::Enumeration)]
#[repr(i32)]
...
impl AccountType {
    ...
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
        match value {
            ...
            "ACCOUNT_TYPE_DFA" => Some(Self::Dfa),
            _ => None,
        }
    }
}
...
impl AccountValue {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            Self::Unspecified => "ACCOUNT_VALUE_UNSPECIFIED",
            Self::MarginFee => "ACCOUNT_VALUE_MARGIN_FEE",
            Self::AmountWithoutExtraFee => "ACCOUNT_VALUE_AMOUNT_WITHOUT_EXTRA_FEE",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
        match value {
            "ACCOUNT_VALUE_UNSPECIFIED" => Some(Self::Unspecified),
            "ACCOUNT_VALUE_MARGIN_FEE" => Some(Self::MarginFee),
            "ACCOUNT_VALUE_AMOUNT_WITHOUT_EXTRA_FEE" => Some(Self::AmountWithoutExtraFee),
            _ => None,
        }
    }
}
...
pub mod users_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn get_account_values(
            &mut self,
            request: impl tonic::IntoRequest<super::GetAccountValuesRequest>,
        ) -> std::result::Result<
            tonic::Response<super::GetAccountValuesResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
